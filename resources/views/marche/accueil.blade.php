...
background-color: white;"
                ...
                <div class="carousel-item {{ $loop->first ? 'active' : '' }}">
                    <div class="article"
                        ...
                        <p style="padding: 10px; position: relative; font-size: 20px">
                            {{ \Illuminate\Support\Str::words($article->resume, 30, '...') }}</p>
            ...
            @foreach ($produits as $produit)
                <div class="col-sm-6 col-md-4 col-lg-3 d-flex justify-content-center">
                    <div class="product-card text-center p-3 shadow" style="border-radius: 10px;">
                        ...
                        <img style="width: 300px" src="images/{{ $produit->image }}" alt="{{ $produit->libelle }}"
    ...
    <div class="chat-section p-4 bg-white rounded shadow-sm">
        ...
        <div class="p-4 bg-white rounded shadow mb-4">
            ...
            <div class="d-flex justify-content-between align-items-center">
                <p class="text-dark mb-0">Tenez un journal précis de votre cycle menstruel et recevez des prévisions
                    personnalisées.</p>
                <a style="background-color: blueviolet; color: white;" href="{{ url('liste-admin') }}"
                    class="rounded-circle p-3">
                    <i class="fas fa-arrow-right"></i>
