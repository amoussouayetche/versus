    ...
    <div class="content-header">
        ...
        <table id="table_personnelle" class="display">
            ...
            <tbody>
                    ...
                    <td>
                        <form method="post" enctype="multipart/form-data">
                            ...
                            <a href=" {{ route('articles.edit', $article->id) }} "
                                ...
                                data-bs-target="#modifier{{ $article->id }}">
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor"
                            ...
                            <a href="{{ route('articles.destroy', $article->id) }} "
                                ...
                                data-bs-target="#supprimer{{ $article->id }}" data-bs-whatever="@mdo"><svg
                ...
                <!-- debut Modal show -->
                @include('page_administration.article.articleShow')
                <!-- fin modal show -->
                <!-- debut Modal modifier -->
                @include('page_administration.article.articleEdit')
                <!-- fin modal modifier -->
                <!-- debut Modal suppression -->
                @include('page_administration.article.articleDestroy')
                <!-- fin modal suppression -->

                @endforeach
                <!-- debut Modal ajouter -->
                @include('page_administration.article.articleCreate')
                <!-- fin modal ajouter -->
